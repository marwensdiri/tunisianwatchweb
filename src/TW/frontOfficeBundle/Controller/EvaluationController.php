...
use TW\frontOfficeBundle\Entity\Evaluation;
use TW\frontOfficeBundle\Form\EvaluationType;
...
class EvaluationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TWfrontOfficeBundle:Evaluation')->findAll();

        return $this->render('TWfrontOfficeBundle:Evaluation:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('TWfrontOfficeBundle:Evaluation:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TWfrontOfficeBundle:Evaluation')->find($id);
        ...
        return $this->render('TWfrontOfficeBundle:Evaluation:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('TWfrontOfficeBundle:Evaluation:edit.html.twig', array(
            'entity'      => $entity,
