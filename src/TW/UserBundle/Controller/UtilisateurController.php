...
use TW\UserBundle\Entity\Utilisateur;
use TW\UserBundle\Form\UtilisateurType;
...
class UtilisateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TWUserBundle:Utilisateur')->findAll();
     ...
     * @Method("POST")
     * @Template("TWUserBundle:Utilisateur:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TWUserBundle:Utilisateur')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TWUserBundle:Utilisateur:edit.html.twig")
     */
