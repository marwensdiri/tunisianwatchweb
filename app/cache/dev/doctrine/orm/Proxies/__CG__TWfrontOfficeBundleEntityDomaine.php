 ...
 */
class Domaine extends \TW\frontOfficeBundle\Entity\Domaine implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nom', 'idetablissement');
        }
    ...
    public function addIdetablissement(\TW\frontOfficeBundle\Entity\Etablissement $idetablissement)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addIdetablissement', array($idetablissement));

        return parent::addIdetablissement($idetablissement);
    }
    ...
    public function removeIdetablissement(\TW\frontOfficeBundle\Entity\Etablissement $idetablissement)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeIdetablissement', array($idetablissement));

        return parent::removeIdetablissement($idetablissement);
    }
